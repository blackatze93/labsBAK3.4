...
{
    /**
     * Metodo que genera el grafico de practica libre por mes.
     *
    ...
    /**
     * Metodo que genera el grafico de practica libre por proyecto curricular.
     *
     * @Route("practica_libre_proyecto/", name="practica_libre_proyecto")
     *
     * @param Request $request
     *
     * @return \Symfony\Component\HttpFoundation\Response
     ...
     * @internal param Request $request
     */
    public function practicaLibreProyectoAction(Request $request)
    {
        $options = array(
            'constraints' => array(
                new Expression(array(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em = $this->getDoctrine()->getManager();
            $prestamos = $em->getRepository(PrestamoPracticaLibre::class)->findPrestamosProyecto(
                array(
    ...
    /**
     * Metodo que genera el grafico de practica libre por sala.
     *
     * @Route("practica_libre_sala/", name="practica_libre_sala")
     *
     * @param Request $request
     *
     * @return \Symfony\Component\HttpFoundation\Response
